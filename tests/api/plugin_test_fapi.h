...
// plugincore
// NOTE: this mirrors the glue generated by cmake/fortran_plugin.{h,F90}.in - keep the two in step.
extern "C" void plugincore_setup_fapi(void* config, void* modelData);
extern "C" void plugincore_run_fapi(void* config, void* modelData, const char* hook);
...
public:
    ...
    void run() override {
        plugincore_run_fapi(&config_, &modelData(), currentHook().c_str());
    }
