...
public:
     ...
     *          the tracker and the write-back lifecycle entirely. PLUME-75 tracks a structural fix to prevent this.
     *
     ...
     *          stored parameter. Mutating the field through this handle bypasses the write-back tracker
